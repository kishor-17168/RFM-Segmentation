...
### 🔹 Data Import Method  
The dataset was imported using the **Table Data Import Wizard** in MYSQL Server.  

### 📄 Files and Descriptions  

| File Name         | Description |
|------------------|-------------|
| **RFM_Segmentation_txt** | Contains all SQL queries used in data extraction, transformation, and analysis. |
| **RFM**  | SQL script for performing RFM (Recency, Frequency, Monetary) analysis on customer data. |
| **Superstore Sales Data csv** | The dataset used for analysis, containing sales, customer, and product information. |
| **RFM-Segmentation_ppt** | A PowerPoint presentation summarizing key insights, visualizations, and findings from the project. |
